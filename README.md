...
| [rpk](./bucket/rpk.json) | Redpanda CLI (rpk) - a single tool for creating, developing, and administering Redpanda clusters | [github.com/redpanda-data/redpanda](https://github.com/redpanda-data/redpanda) |
...
| [trunk](./bucket/trunk.json) | Universal linter, formatter and code quality manager for polyglot repositories | [docs.trunk.io/code-quality/overview](https://docs.trunk.io/code-quality/overview) |
